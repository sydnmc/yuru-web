...
the `webserver` folder contains code to help with the backend, specifically allowing for automatic updates of each subdomain's gd page, as well as the ability to easily add new maps to the database.
