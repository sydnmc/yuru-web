            ...
            dropdown: [
              {
                ...
                },
                {
                    ...
                    link: getPageRoot("syd") + "gds",
                },
            ],
        },
        {
            name: "music",
            link: getPageRoot("syd") + "music",
        },
    ];
...
<div id="header">
    <a href={prevPage}>
        <img id="pfp-image" src={sydPfp} alt={pfpAlt} />
    </a>
    <h1>{username}</h1>
...
<style>
    ...
    #header {
        /* probably originally supposed to scroll with the page? */
        display: flex;
        position: relative;
        align-items: center;
    ...
    .button-with-dropdown-container:hover .dropdown-content {
        /* makes dropdown content visible when hovered over */
        display: block;
    }
    ...
    .dropdown-content {
        ...
        width: calc(
            244px + 10px
        ); /* really not a good way to go about it, but the box with osu! text is 244px */
    ...
    .dropdown-content a:hover {
        /* makes dropdowns darker when you hover as well */
        background-color: var(--local-accent);
        border-radius: 5px;
    }
