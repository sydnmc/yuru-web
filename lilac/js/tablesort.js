...
(function (n) {
    ...
    function v(n) {
        if ("TABLE" == n.nodeName) {
            ...
            t(p, function (n, t) {
                l[t] = 0;
                var a = n.classList;
                a.add("gdtab-sort-header"),
                    n.addEventListener("click", function () {
                        var n = l[t];
                        !(function () {
                            for (var n = 0; n < h; ++n) {
                                var r = p[n].classList;
                                r.remove("gdtab-sort-asc"), r.remove("gdtab-sort-desc"), (l[n] = 0);
                            }
                        })(),
                            (n = 1 == n ? -1 : +!n) && a.add(n > 0 ? "gdtab-sort-asc" : "gdtab-sort-desc"),
                            (l[t] = n);
                        var i,
                            f = g[t],
                            m = function (r, t) {
    ...
    n.addEventListener("DOMContentLoaded", function () {
        for (var t = n.getElementsByClassName("gdtab"), e = 0; e < r(t); ++e)
            try {
                v(t[e]);
            } catch (n) {}
    });
